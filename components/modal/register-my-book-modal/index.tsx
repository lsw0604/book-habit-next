import type { MyBookRegistrationType } from '@/schemas/my-book/registration';
...
import useMyBookRegistrationForm from '@/hooks/my-book/useMyBookRegistrationForm';
...
export default function RegisterMyBookModal() {
  ...
  const onSubmit = (data: MyBookRegistrationType) => {
    mutate(data, {
      onSuccess: () => {
