...
export const myBookRegistrationSchema = z.object({
  title: z.string(), // 도서 제목
  contents: z.string(), // 도서 소개
  url: z.string().url(), // 도서 상세 URL
  isbn: z.array(z.string()), // ISBN10 또는 ISBN13 형식의 국제 표준 도서번호
...
export type MyBookRegistrationType = z.infer<typeof myBookRegistrationSchema>;

export const DEFAULT_MY_BOOK_REGISTRATION: MyBookRegistrationType = {
  title: '',
  contents: '',
  url: '',
  isbn: [],
